...
// Кривые Безье, полином Бернштейна
...
public class Bezier
{
    ...
    private void setCoords(double sx, double sy, double[] coords, int numCoords)
    {
    ...
    // приблизительная длина кривой Безье (> реальной длины)
